...
class CrawlStartRequest(BaseModel):
    ...
    max_requests: int = Field(10000, description="Maximum total requests")
    concurrency: int = Field(10, description="Concurrent request workers")
    request_delay: float = Field(0.0, description="Base delay between requests (seconds)")
    request_timeout: float = Field(30.0, description="HTTP request timeout (seconds)")
